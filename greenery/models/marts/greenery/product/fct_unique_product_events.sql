...
-- THIS LAYER PROVIDES THE DISTINCT SESSION CRITERIA DRIVIN BY THE PRODUCT CONVERSION RATE DEFINITION
-- WITHOUT THIS LAYER WE WOULD AGGREGATE OVER ALL SESSIONS AND NOT DISTINCT SESSIONS IN THE FINAL CTE
...
-- AGGREGRATE EVENT TYPES BY PRODUCT AND ONLY COUNT DISTINCT SESSION ID
final as (
